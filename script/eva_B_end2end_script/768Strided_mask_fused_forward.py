...
@torch.jit.script
def fused_with_jit_gemm1_bias1_lynorm1(attr_output_kernel_this, attr_output_bias_this, attr_output_layernorm_gamma_this, attr_output_layernorm_beta_this, input_tensor, hidden_states):
...
@torch.jit.script
def fused_with_jit_gemm2_bias2act(inter_kernel_this, inter_bias_this, hidden_states):
...
@torch.jit.script
def fused_with_jit_bias3_lynorm3(output_bias_this, output_layernorm_gamma_this, output_layernorm_beta_this, residual, hidden_states):
    ...
    for i in range(warmup_iters + iters):
        ...
        with torch.no_grad():
            ...
            for layer in range(layer_num):
                ...
                residual, hidden_states = fused_with_jit_gemm1_bias1_lynorm1(attr_output_kernel_this, attr_output_bias_this, attr_output_layernorm_gamma_this, attr_output_layernorm_beta_this, input_tensor, hidden_states)

                hidden_states = fused_with_jit_gemm2_bias2act(inter_kernel_this, inter_bias_this, hidden_states)

                hidden_states = torch.matmul(hidden_states, output_kernel_this)            # 12 GEMM3
                
                hidden_states = fused_with_jit_bias3_lynorm3(output_bias_this, output_layernorm_gamma_this, output_layernorm_beta_this, residual, hidden_states)

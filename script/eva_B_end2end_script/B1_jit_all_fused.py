...
@torch.jit.script
def fused_with_jit_gemm0_bias0_QK_mask_sfmx_pV_trans_gemm1_bias1_lynorm1_gemm2_bias2act_gemm3_bias3_lynorm3(qkv_kernel_this, qkv_bias_this, attr_output_kernel_this, attr_output_bias_this, attr_output_layernorm_gamma_this, attr_output_layernorm_beta_this, inter_kernel_this, inter_bias_this, output_kernel_this, output_bias_this, output_layernorm_gamma_this, output_layernorm_beta_this, mask, hidden_states):
    ...
    for i in range(warmup_iters + iters):
        ...
        with torch.no_grad():
            ...
            for layer in range(layer_num):
                ...
                hidden_states = fused_with_jit_gemm0_bias0_QK_mask_sfmx_pV_trans_gemm1_bias1_lynorm1_gemm2_bias2act_gemm3_bias3_lynorm3(qkv_kernel_this, qkv_bias_this, attr_output_kernel_this, attr_output_bias_this, attr_output_layernorm_gamma_this, attr_output_layernorm_beta_this, inter_kernel_this, inter_bias_this, output_kernel_this, output_bias_this, output_layernorm_gamma_this, output_layernorm_beta_this, mask, hidden_states)

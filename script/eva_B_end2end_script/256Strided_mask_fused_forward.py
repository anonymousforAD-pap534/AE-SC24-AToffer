...
@torch.jit.script
def fused_with_jit_lynorm1_gemm2_bias2act_gemm3(attr_output_layernorm_gamma_this, attr_output_layernorm_beta_this, inter_kernel_this, inter_bias_this, output_kernel_this, hidden_states):
    ...
    for i in range(warmup_iters + iters):
        ...
        with torch.no_grad():
            ...
            for layer in range(layer_num):
                ...
                residual, hidden_states = fused_with_jit_lynorm1_gemm2_bias2act_gemm3(attr_output_layernorm_gamma_this, attr_output_layernorm_beta_this, inter_kernel_this, inter_bias_this, output_kernel_this, hidden_states)

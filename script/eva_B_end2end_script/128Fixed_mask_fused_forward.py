...
@torch.jit.script
def fused_with_jit_gemm2_bias2act_gemm3(inter_kernel_this, inter_bias_this, output_kernel_this, hidden_states):
    ...
    for i in range(warmup_iters + iters):
        ...
        with torch.no_grad():
            ...
            for layer in range(layer_num):
                ...
                hidden_states = fused_with_jit_gemm2_bias2act_gemm3(inter_kernel_this, inter_bias_this, output_kernel_this, hidden_states)
